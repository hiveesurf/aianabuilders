...
import { FiMapPin, FiStar, FiHome, FiSquare, FiArrowRight } from 'react-icons/fi'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-estate-medium max-w-3xl mx-auto">
            Top-rated residential projects in Faridabad and NCR
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-estate-dark mb-2">{project.name}</h3>
                ...
                <div className="pt-4 border-t border-gray-200">
                  <p className="text-2xl font-bold text-estate-dark mb-4">{project.price}</p>
                  <a
