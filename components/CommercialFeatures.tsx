        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <ul className="space-y-4">
              {features.map((feature, index) => (
                ...
                >
                  <FiCheckCircle className="w-6 h-6 text-accent-600 flex-shrink-0 mt-0.5" />
          ...
          >
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h2 className="text-3xl font-serif font-bold text-estate-dark">Property Types</h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {types.map((type, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.5, delay: index * 0.1 }}
                  className="flex items-center space-x-2 p-3 bg-gradient-to-r from-accent-50 to-black50 rounded-lg"
                >
                  <FiCheckCircle className="w-5 h-5 text-accent-600 flex-shrink-0" />
                  <span className="text-estate-dark font-medium">{type}</span>
                </motion.div>
              ))}
            </div>
          </motion.div>
