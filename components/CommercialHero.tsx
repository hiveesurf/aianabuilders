      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <p className="text-xl text-white max-w-3xl mx-auto mb-8 drop-shadow-md">
            Find the perfect commercial space for your business in Faridabad and NCR. From office spaces to retail shops, we have it all.
          </p>
          <a
            href={generateWhatsAppUrl({ type: 'Commercial Property' })}
            target="_blank"
